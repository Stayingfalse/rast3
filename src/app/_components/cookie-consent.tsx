    ...
    <div className={`fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 shadow-lg ${className}`}>
      <div className="container mx-auto px-4 py-4">
        ...
        <div className="mt-3 text-xs text-gray-500">
          <p>
            <strong>Essential cookies</strong> are always enabled to ensure the site functions properly. 
            <strong> Optional cookies</strong> include analytics and personalization features.
          </p>
        </div>
      </div>
    </div>
